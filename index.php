  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/cowork2.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown"> A work experience like never before</h2>
              <p class="animate__animated animate__fadeInUp">It’s as necessary to have a distraction-free workplace 
               as much as it is necessary to have work on your plate </p>
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(assets/img/cowork3.jpeg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">GET YOUR HANDS ON THE OFFICE OF YOUR DREAMS</h2>
              <p class="animate__animated animate__fadeInUp">It’s as necessary to have a distraction-free workplace as much as 
               it is necessary to have work on your plate </p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Pole Workspaces <br/> 
                33/1, Rachana Galaxy, 21st, Marenahalli Main Rd, Vijayanagar, 
                Bengaluru, Karnataka 560040</p>
